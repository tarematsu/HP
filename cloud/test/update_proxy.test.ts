...
function manifest(): string {
  return JSON.stringify({
    ...
    signed: false,
    files: [
      { name: "HomePanel.exe", sha256: "a".repeat(64), size: 10, requireAuthenticode: false },
      { name: "HomePanelUpdater.exe", sha256: "b".repeat(64), size: 11, requireAuthenticode: false },
      { name: "WebView2Loader.dll", sha256: "c".repeat(64), size: 12, requireAuthenticode: true },
    ],
  });
}
