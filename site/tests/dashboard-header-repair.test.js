...
test('dashboard header repair runs before tabs and dashboard client startup', () => {
  assert.ok(dashboardEntry.indexOf("import './dashboard-header.js?v=20260919.1'") < dashboardEntry.indexOf("import './dashboard-tabs.js?v=20260919.1'"));
  assert.match(headerRepair, /dashboard-fixes\.css\?v=20260919\.1/);
