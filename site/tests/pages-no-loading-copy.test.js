...
test('silent loading changes are cache busted through the Pages entry chain', () => {
  ...
  assert.match(tabs, /history-main\.js\?v=20260927\.1/);
  ...
  assert.match(dashboardEntry, /dashboard-tabs\.js\?v=20260927\.2/);
  assert.match(html, /dashboard-metrics\.js\?v=20260927\.4/);
});
