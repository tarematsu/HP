...
test('dashboard has one response parser and one canvas renderer', () => {
  ...
  assert.match(dashboard, /dashboard-chart-comparison\.js\?v=20260923\.5/);
  assert.match(dashboard, /dashboard-chart-detail\.js\?v=20260923\.4/);
  assert.match(dashboard, /dashboard-fetch-cache\.js\?v=20260923\.6/);
...
test('history has one specialized canvas renderer per mode and hides paint until it settles', () => {
  ...
  assert.match(historyMain, /history-ranking-chart\.js\?v=20260923\.7/);
