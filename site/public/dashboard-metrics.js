...
import './dashboard-header.js?v=20260923.6';
...
import './dashboard-daily-summaries.js?v=20260923.6';
import './dashboard-fetch-cache.js?v=20260923.6';
...
void import('/dashboard-client.js?v=20260923.6').catch((error) => {
