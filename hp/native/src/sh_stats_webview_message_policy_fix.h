...
// The July 19 payload has no request/document/auth generation ids. Consume the
// successful stats object before the later generation-aware handler sees it,
// while preserving the current exact-origin and auth-completion wrappers for
// every other message.
