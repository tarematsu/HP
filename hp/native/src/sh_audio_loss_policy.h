...
inline constexpr int64_t kStationheadAudioLossArmStabilityMs = 10'000;
...
static_assert(!StationheadAudioLossCanArm(true, false, 9'999));
static_assert(StationheadAudioLossCanArm(true, false, 10'000));
