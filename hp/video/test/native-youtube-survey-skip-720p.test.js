...
test('ad skip and fullscreen fallback recover hidden controls without a fixed wait', () => {
  ...
  assert.doesNotMatch(runtime, /(?:document\.|element\.)requestFullscreen|webkitRequestFullscreen/);
});
