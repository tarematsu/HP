...
<div class="row" style="margin-top:12px"><button id="load" class="primary">クラウド設定を読み込む</button><button id="save" class="primary">保存して端末を再起動</button></div><div id="status" class="status"></div><div class="muted">Cloudflare同期は1800秒、CO2・温湿度アップロードは240分で固定されます。Spotifyは端末から直接取得します。</div></section>
