...
const RADAR_OUTPUT_WIDTH = 1296;
const RADAR_OUTPUT_HEIGHT = 729;
const RADAR_COMPOSITION_VERSION = "radar-frame-v11-z10-1296x729-native-scale-location-marker-day-cap";
