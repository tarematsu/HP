...
const RADAR_PANEL_SOURCE_WIDTH = 480;
const RADAR_PANEL_SOURCE_HEIGHT = 960;
const RADAR_BASE_CROP_WIDTH = 480;
const RADAR_BASE_CROP_HEIGHT = 960;
const RADAR_OUTPUT_WIDTH = 1440;
const RADAR_OUTPUT_HEIGHT = 960;
const RADAR_COMPOSITION_VERSION = "radar-frame-v7-z10-1440x960-native-scale-time-only-top-70";
